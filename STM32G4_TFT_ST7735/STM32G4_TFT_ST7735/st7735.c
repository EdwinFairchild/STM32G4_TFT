...
extern void spi_send_dma(uint8_t *data, uint32_t len);
...
void ST7735_printMsg(uint8_t x, uint8_t y,uint16_t color, char *msg, ...)
{
	...
	ST7735_WriteString(x, y, buff, Font_7x10, color, ST7735_BLACK);
